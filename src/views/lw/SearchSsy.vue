...
<!--        &lt;!&ndash;获取时间段内（店铺&#45;&#45;可选）的各系统订单量&ndash;&gt;-->
...
<!--        &lt;!&ndash;获取时间段内的各系统订单量top n的list&ndash;&gt;-->
...
<!--                        </thead>-->
<!--                        <tbody>-->
<!--                            <template v-if="tableTopInfo.orderLimit && tableTopInfo.orderLimit.length > 0">-->
<!--                                <tr v-for="item in tableTopInfo.orderLimit">-->
<!--                                    <td>{{ item.shopNick }}</td>-->
<!--                                    <td>{{ item.count }}</td>-->
<!--                                </tr>-->
<!--                            </template>-->
<!--                        </tbody>-->
<!--                    </table>-->
<!--                    <div v-if="!tableTopInfo.orderLimit || tableTopInfo.orderLimit.length === 0" class="table-note">-->
<!--                        <i class="iconfont icon-xiaolian"></i>暂无数据-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
...
<!--                const { jushitaCount = 0, originCount = 0, syncCount = 0, orderCount = 0 } = res.data.resp;-->
<!--                this.tableOneInfo = { jushitaCount, originCount, syncCount, orderCount };-->
<!--            } else {-->
<!--                this.tableOneInfo = {};-->
<!--            }-->
<!--        },-->
